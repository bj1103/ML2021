...
teacher.load_state_dict(torch.load("./model_1.ckpt"))
teacher.eval()
...
model.device = device
# model.load_state_dict(torch.load(prepath+"model_old.ckpt"))
...
for epoch in range(n_epochs):
    ...
    if valid_acc > max_val_acc:
        torch.save(model.state_dict(), prepath+"model_2.ckpt")
